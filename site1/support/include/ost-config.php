...
define('SECRET_SALT','JqTuor00iahAgspOPb6X7Gma9tIjHMPz');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','cw426@kent.ac.uk');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','db604421020.db.1and1.com');
define('DBNAME','db604421020');
define('DBUSER','dbo604421020');
define('DBPASS','PeterRodgers1!');
